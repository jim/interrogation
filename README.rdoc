...
Also, obviously, this hits the database with each call. YMMV.

== Possible future plans

Determining the state of an object by parsing conditions from the scope definition and checking these against the current model attributes.
